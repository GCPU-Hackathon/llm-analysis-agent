...
async def start_conversation_route(req: StartConversationRequest):
    """Start a new conversation with RAG"""
    return await conversation_controller.start_conversation(req)

@app.post("/conversation/{conversation_id}/continue", response_model=ConversationResponse)
async def continue_conversation_route(conversation_id: str, req: ContinueConversationRequest):
    """Continue an existing conversation"""
    return await conversation_controller.continue_conversation(conversation_id, req)
